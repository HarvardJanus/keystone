...
class GeoMappingSuite extends FunSuite with Logging {
  test("Geo Matrix-to-Matrix Mapping test"){
    ...
    val mappingWithIndex = GeoMappingWithIndex(mapping)
    assert(mappingWithIndex.qForward(List(Coor(2,2))).toString == "List((0,1), (0,2), (0,3), (1,1), (1,2), (1,3), (2,1), (2,2), (2,3))")
    assert(mappingWithIndex.qBackward(List(Coor(1,2))).toString == "List((0,2), (1,1), (1,2), (1,3), (2,0), (2,1), (2,2), (2,3), (2,4), (3,1), (3,2), (3,3), (4,2))")
  }
