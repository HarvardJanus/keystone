...
JNIEXPORT jint JNICALL Java_pipelines_astronomy_Background_sep_1makeback
(JNIEnv *env, jobject obj, jbyteArray data, jobjectArray maskdata, jint dtype, jint mdtype, jint w, jint h, jint
 bw, jint bh, jdouble mthresh, jint fw, jint fh, jdouble fthresh, jobject backmap){
  ...
  assert(cls != NULL);
  jfieldID id_bkmap = (*env)->GetFieldID(env, cls, "bkgmap", "Lpipelines/astronomy/Sepbackmap;"); 
...
JNIEXPORT jint JNICALL Java_pipelines_astronomy_Background_sep_1backarray
...
JNIEXPORT jint JNICALL Java_pipelines_astronomy_Background_sep_1subbackarray
