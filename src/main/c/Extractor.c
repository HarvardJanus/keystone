...
JNIEXPORT jint JNICALL Java_pipelines_astronomy_Extractor_sep_1sum_1circle
...
JNIEXPORT jint JNICALL Java_pipelines_astronomy_Extractor_sep_1sum_1circann
...
JNIEXPORT jint JNICALL Java_pipelines_astronomy_Extractor_sep_1sum_1ellipse
...
JNIEXPORT jint JNICALL Java_pipelines_astronomy_Extractor_sep_1sum_1ellipann
...
JNIEXPORT jint JNICALL Java_pipelines_astronomy_Extractor_sep_1extract
  (JNIEnv *env, jobject obj, jbyteArray data, jbyteArray nstream, jint dtype, jint ndtype, jshort noise_flag, jint w, jint h, jfloat thresh, jint minarea, jbyteArray cstream, jint convw, jint convh, jint deblend_nthresh, jdouble deblend_cont, jboolean clean_flag, jdouble clean_param, jobjectArray objects, jint nobj)
{
  ...
  assert(cls != NULL);
  jmethodID consID = (*env)->GetMethodID(env, cls, "init_obj", "(DIIIIIIDDDDDFFFFFFFFFFIIIISI)Lpipelines/astronomy/Sepobj;");
  assert(consID != NULL);
...
JNIEXPORT void JNICALL Java_pipelines_astronomy_Extractor_sep_1ellipse_1coeffs
...
JNIEXPORT void JNICALL Java_pipelines_astronomy_Extractor_sep_1ellipse_1axes
...
JNIEXPORT void JNICALL Java_pipelines_astronomy_Extractor_sep_1kron_1radius
...
JNIEXPORT void JNICALL Java_pipelines_astronomy_Extractor_sep_1set_1ellipse
